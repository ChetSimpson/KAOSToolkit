...
namespace hypertech::kaos::assetfoo::images::mge::unittests
{
	...
	namespace
	{
		using mge_image_reader_test_expectations = assetfoo::unittests::tc1014_image_reader_test_expectations<320, 200>;
		...
		struct titlepage_mge_expectations : mge_image_reader_test_expectations
		{
