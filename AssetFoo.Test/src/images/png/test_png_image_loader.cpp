...
namespace hypertech::kaos::assetfoo::images::png::unittests
{
	...
	namespace
	{
		...
		struct test1_base_png_expectations : png_image_reader_test_expectations<
			320, 200,
		...
		struct ghouls_and_ghosts_png_expectations : png_image_reader_test_expectations<
			320, 225,
			0x08030356, 0x5edfcac5, 0x4251c751, 0x2541c215>
		{
			static const inline auto filename = "TestData/images/png/ghouls_and_ghosts.png";
		};

		struct aladdin_png_expectations : png_image_reader_test_expectations<
			32, 90,
			0x63eb9c98, 0x37bd220a, 0x549b6942, 0xecc74919>
		{
			static const inline auto filename = "TestData/images/png/aladdin.png";
		};

		struct bjoink_png_expectations : png_image_reader_test_expectations<
			80, 90,
			0x59df19bf, 0x63cdf609, 0x60de2bbe, 0x789ad90d>
		{
			static const inline auto filename = "TestData/images/png/bjoink.png";
		};

		struct ninja_gaiden_png_expectations : png_image_reader_test_expectations<
			56, 63,
			0xbc3d4839, 0xebd0aa96, 0xd2ffcc1f, 0xfd8197de>
		{
